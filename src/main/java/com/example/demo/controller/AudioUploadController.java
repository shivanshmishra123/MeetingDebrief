...
public class AudioUploadController {
    ...
    public ResponseEntity<?> uploadAudio(
        ...
        try {
            ...
            // TranscriptionService handles the HTTP multipart call to FastAPI
            ...
            // STEP 2: Package the transcript into our existing DTO
            // This is the SAME object MeetingController uses — so we're reusing
            // the exact same pipeline that was already built and tested.
            MeetingUploadRequest request = new MeetingUploadRequest();
            request.title = title;
            request.transcript = transcript;

            // STEP 3: Run the full meeting processing pipeline
            // (structured extraction → PostgreSQL + Pinecone vectorization)
